...
with open(BASE_DIR.parent / "config_dev.yaml") as f:
...
try:
    SECURE_HSTS_INCLUDE_SUBDOMAINS = yaml_content["DJANGO"][
...
# Login by email only, sign up with just email + a single password field
