...
#
# Addendum 1: I had to reset the indexing sequence to max(id)+1 in the db, because Django wanted to start with id 1 ...
# (see [here](https://stackoverflow.com/a/118402/13797028))
#
# Addendum 2: Something went terribly wrong when I transferred the record-label-link table. Nearly all relationships got messed up ... had to fix manually. Better testing would have saved me probably ...
# +
import sys
